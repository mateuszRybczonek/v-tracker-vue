    ...
    <g id="drawing">
      <g id="palette">
        <g ref="dark">
          ...
          <path d="M65 93.5L41.8 82.2l33.9-70L99 23.5zm-21.1-12l20.4 9.9 32.5-67.2-20.3-9.9z" fill="#999"/>
          <path transform="rotate(-64.1 81.575 30.396)" fill="#999" d="M72.5 21.4h18.1v18.05H72.5z"/>
          <path transform="rotate(-64.1 72.191 49.644)" fill="#87898e" d="M63.2 40.6h18.1v18.06H63.2z"/>
          <path transform="rotate(-64.1 62.888 68.943)" fill="#68696d" d="M53.8 59.9h18.1v18.05H53.8z"/>
        </g>
        <g ref="med">
          <path transform="rotate(-78.9 57.558 49.808)" fill="#fff" d="M19.4 37.7h76.3v24.23H19.4z"/>
          <path d="M61.1 88.7l-25.3-5 15-76.4 25.4 5zm-23.4-6.2l22.2 4.3 14.4-73.2-22.2-4.4z" fill="#999"/>
          <path transform="rotate(-78.9 61.042 23.53)" fill="#bec0c4" d="M52 14.5h18.1v18.05H52z"/>
          <path transform="rotate(-78.9 56.93 44.502)" fill="#a6a8ad" d="M47.9 35.5H66v18.05H47.9z"/>
          <path transform="rotate(-78.9 52.758 65.425)" fill="#999" d="M43.8 56.4h18.1v18.05H43.8z"/>
        </g>
        <g ref="light">
          <path fill="#fff" d="M28 9.6h24.2v76.25H28z"/>
          <path d="M51.2 85.2H25.3V7.4h25.9zm-24.3-1.6h22.6V9H26.9z" fill="#999"/>
          <path fill="#dcdfe5" d="M29.5 12.2h18.1v18.05H29.5z"/>
          <path fill="#bec0c4" d="M29.5 33.6h18.1v18.05H29.5z"/>
          <path fill="#a6a8ad" d="M29.5 55h18.1v18.05H29.5z"/>
        </g>
      </g>
      <g ref="pen" id="pen">
        <path transform="rotate(-54.1 25.93 61.88)" fill="#68696d" d="M-7.7 59.1h67.2v5.53H-7.7z"/>
