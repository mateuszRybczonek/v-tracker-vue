...
export const SET_SELECTED_VESSEL_DETAILS_COMPONENT = 'SET_SELECTED_VESSEL_DETAILS_COMPONENT'
export const SET_DASHBOARD_GOOGLE_MAP = 'SET_DASHBOARD_GOOGLE_MAP'
